document.addEventListener("DOMContentLoaded", function () {
    ...
    //         '<div class="text-center p-5"><div class="spinner-border text-primary" role="status"></div><p class="mt-2">Cargando datos de ' +
    //         dataType +
    //         "...</p></div>";
    ...
    // const initialType =
    //     document
    //         .querySelector(".kpi-card.active")
    //         ?.getAttribute("data-table") || "clientes";
